...
class MessageDeliveryStatus(models.Model):
    ...
    message = models.ForeignKey('zerver.Message', on_delete=CASCADE, related_name='delivery_statuses')
    recipient = models.ForeignKey('zerver.UserProfile', on_delete=CASCADE, related_name='message_delivery_statuses')
